...
import com.nhoryzon.mc.eidolon.Configuration;
...
public class EidolonModMenu implements ModMenuApi {
    ...
    private Screen buildConfigScreen(Screen parent) {
        ConfigBuilder builder = ConfigBuilder.create()
                ...
                .setSavingRunnable(() -> Configuration.save(EidolonMod.CONFIG))
                .setTitle(Text.literal(String.format("%s Config", EidolonMod.MOD_NAME_PRETTY)));
