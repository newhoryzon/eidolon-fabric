...
import com.nhoryzon.mc.eidolon.recipe.ingredient.ChanceResult;
...
public class ChanceArrayIngredient extends AbstractList<EntryStack<?>> implements EntryIngredient, RandomAccess {
    ...
    public ChanceArrayIngredient(EntryStack<?>[] array, float chance) {
        ...
        this.chance = chance;
        Arrays.stream(this.array).forEach(entryStack -> entryStack.tooltip(EidolonMod.i18n("rei.chance",
